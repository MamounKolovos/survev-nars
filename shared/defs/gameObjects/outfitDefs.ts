...
const SkinDefs: Record<string, OutfitDef> = {
    ...
    outfitSunburn: defineOutfitSkin("outfitBase", {
        ...
        skinImg: {
            baseTint: 0xffffff,
            baseSprite: "player-base-outfitSunburn.img",
            handTint: 0xffffff,
            handSprite: "player-hands-outfitSunburn.img",
            footTint: 0xffffff,
            footSprite: "player-feet-01.img",
            backpackTint: 0xffffff,
            backpackSprite: "player-back-outfitSunburn.img",
        },
        lootImg: {
            sprite: "loot-shirt-outfitSunburn.img",
            tint: 0xffffff,
        },
    }),
    outfitToontooine: defineOutfitSkin("outfitBase", {
        ...
        skinImg: {
            baseTint: 0xffffff,
            baseSprite: "player-base-outfitToontooine.img",
            handTint: 0xffffff,
            handSprite: "player-hands-outfitToontooine.img",
            footTint: 0xffffff,
            footSprite: "player-feet-01.img",
            backpackTint: 0xffffff,
            backpackSprite: "player-back-outfitToontooine.img",
        },
        lootImg: {
            sprite: "loot-shirt-outfitToontooine.img",
            tint: 0xffffff,
        },
    }),
    ...
    outfitBubblegum: defineOutfitSkin("outfitBase", {
        ...
        skinImg: {
            baseTint: 0xffffff,
            baseSprite: "player-base-outfitBubblegum.img",
            handTint: 0xffffff,
            handSprite: "player-hands-outfitBubblegum.img",
            footTint: 0xffffff,
            footSprite: "player-feet-01.img",
            backpackTint: 0xffffff,
            backpackSprite: "player-back-outfitBubblegum.img",
        },
        lootImg: {
    ...
    outfitRedLava: defineOutfitSkin("outfitBase", {
        ...
        skinImg: {
            baseTint: 0xffffff,
            baseSprite: "player-base-outfitRedLava.img",
            handTint: 0xffffff,
            handSprite: "player-hands-outfitRedLava.img",
            footTint: 0xffffff,
            footSprite: "player-feet-01.img",
            backpackTint: 0xffffff,
            backpackSprite: "player-back-outfitRedLava.img",
        },
        lootImg: {
    ...
    outfitBuckTeeth: defineOutfitSkin("outfitBase", {
        ...
        skinImg: {
            baseTint: 0xffffff,
            baseSprite: "player-base-outfitBuckTeeth.img",
            handTint: 0xffffff,
            handSprite: "player-hands-outfitBuckTeeth.img",
            footTint: 0xffffff,
            footSprite: "player-feet-01.img",
            backpackTint: 0xffffff,
            backpackSprite: "player-back-outfitBuckTeeth.img",
            accessoryImg: {
                sprite: "player-accessory-outfitBuckTeeth.img",
                pos: v2.create(5, 0),
                scale: 0.26,
                aboveHands: true,
            },
        ...
        lootImg: {
            sprite: "loot-shirt-outfitBuckTeeth.img",
            tint: 0xffffff,
        },
    }),
    outfitAvocadoh: defineOutfitSkin("outfitBase", {
        ...
        skinImg: {
            baseTint: 0xffffff,
            baseSprite: "player-base-outfitAvocadoh.img",
            handTint: 0xffffff,
            handSprite: "player-hands-outfitAvocadoh.img",
            footTint: 0xffffff,
            footSprite: "player-feet-01.img",
            backpackTint: 0xffffff,
            backpackSprite: "player-back-outfitAvocadoh.img",
        },
        lootImg: {
            sprite: "loot-shirt-outfitAvocadoh.img",
            tint: 0xffffff,
        },
    }),
    outfitAurora: defineOutfitSkin("outfitBase", {
        ...
        skinImg: {
            ...
            footSprite: "player-feet-02.img",
            backpackTint: 0xffffff,
            backpackSprite: "player-back-outfitAurora.img",
        },
        lootImg: {
    ...
    outfitGold: defineOutfitSkin("outfitBase", {
        ...
        skinImg: {
            ...
            backpackTint: 0xffffff,
            backpackSprite: "player-back-outfitGold.img",
        },
        lootImg: {
